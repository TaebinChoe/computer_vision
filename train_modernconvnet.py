...
from models.modernconvnet import ModernConvNet
...
def get_args():
    ...
    parser.add_argument('--title', default='modern_convnet', type=str)
    ...
    parser.add_argument('--dims', nargs='+', default=[96, 192, 384, 576], type=int)
    parser.add_argument('--kernel_size', default=3, type=int)
    parser.add_argument('--expand_ratio', default=2, type=int)
